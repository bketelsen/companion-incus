...
4. Configure the **controls row**:
   ...
   - **Environment profile** (optional): Apply an [environment profile](/guides/incus-environments)
...
```bash
curl -X POST https://your-server:3456/api/agents/pr-reviewer/webhook/YOUR_SECRET \
