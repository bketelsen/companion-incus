...
Companion Incus integrates with [Linear](https://linear.app) to let you search issues, create new ones, link them to sessions, and automatically transition issue status as you work.
...
Linear has a 5,000 requests/hour rate limit. Companion Incus manages this with built-in caching:
